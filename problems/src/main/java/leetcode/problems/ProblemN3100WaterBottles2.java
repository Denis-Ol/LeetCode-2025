...
public class ProblemN3100WaterBottles2 {
/* 3100. Water Bottles II
Medium, Topics: Math,Simulation
...
Return the maximum number of water bottles you can drink. */
    ...
    public static int maxBottlesDrunk(int numBottles, int numExchange) {
        ...
        int full = numBottles, drunk = 0, empty = 0;
        do {
            drunk += full;
            empty += full;
            full = 0;
            ...
            full++;
            numExchange++;
        } while (numExchange <= empty + full);
        return drunk + full;
    }

    public static void main(String[] args) {
        System.out.println("maxBottlesDrunk(13, 6) = " + maxBottlesDrunk(13, 6));
    }
}
