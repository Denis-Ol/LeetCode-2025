import leetcode.problems.ProblemN2461MaximumSumOfDistinctSubarraysWithLengthK;
...
//                com.denis.leetcode.problems.ProblemN2461.maximumSubarraySum(new int[]{1, 5, 4, 2, 9, 9, 9}, 3), "Example 0-test failed");
        Assertions.assertEquals(15,
                ProblemN2461MaximumSumOfDistinctSubarraysWithLengthK.maximumSubarraySum(new int[]{1, 5, 4, 2, 9, 9, 9}, 3), "Example 1 failed");
        Assertions.assertEquals(0,
                ProblemN2461MaximumSumOfDistinctSubarraysWithLengthK.maximumSubarraySum(new int[]{4, 4, 4}, 3), "Example 2 failed");
        Assertions.assertEquals(3,
                ProblemN2461MaximumSumOfDistinctSubarraysWithLengthK.maximumSubarraySum(new int[]{1, 2, 2}, 2), "Example 3 failed");
        Assertions.assertEquals(24,
                ProblemN2461MaximumSumOfDistinctSubarraysWithLengthK.maximumSubarraySum(new int[]{1, 1, 1, 7, 8, 9}, 3), "Example 4 failed");
        Assertions.assertEquals(5000050000L,
                ProblemN2461MaximumSumOfDistinctSubarraysWithLengthK.maximumSubarraySum(
